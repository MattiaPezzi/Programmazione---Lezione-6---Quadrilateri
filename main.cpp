...
int main() {
	...
	A->Dump(); // prende la dump del quadrilatero
	cout << "**** ***** ****" << endl;
	...
	rectA.Dump(); // prende la dump del rettangolo
	cout << "**** ***** ****" << endl;
	...
	cout << endl;
	cout << "**** quadrilateral A ****" << endl;
	A->Dump(); // A e B hanno lati uguali ma sno due oggetti diversi
	cout << "**** ***** ****" << endl;
	cout << "**** quadrilateral B ****" << endl;
	B->Dump(); 
	cout << "**** ***** ****" << endl;
...
//	C->GetArea(); //sbagliato non esiste GetArea in quadrilatero
//  rhoC.GetArea() è la versione corretta
